...
Clasifica una imagen de hoja de vida y devuelve la predicción del modelo seleccionado.
...
Proyecto universitario para la materia de Inteligencia Artificial
